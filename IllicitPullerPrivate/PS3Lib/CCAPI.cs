...
namespace PS3Lib
{
    ...
    public class CCAPI
    {
        ...
        {
            return connectConsole(targetIP);
        }
        ...
        public string GetFirmwareType()
        {
            if (pInfo.ConsoleType == 0)
                GetTargetInfo(out pInfo);
            switch (pInfo.ConsoleType)
            {
                case (int)ConsoleType.CEX: return "CEX";
                case (int)ConsoleType.DEX: return "DEX";
                case (int)ConsoleType.TOOL: return "TOOL";
                default: return "UNK";
            }
        }
