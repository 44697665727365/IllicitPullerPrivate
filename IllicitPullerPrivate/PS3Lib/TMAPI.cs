...
namespace PS3Lib
{
    ...
    public class TMAPI
    {
        ...
        public void ResetToXMB(ResetTarget flag)
        {
            switch (flag)
            {
                case ResetTarget.Hard: resetParameter = PS3TMAPI.ResetParameter.Hard; break;
                case ResetTarget.Quick: resetParameter = PS3TMAPI.ResetParameter.Quick; break;
                case ResetTarget.ResetEx: resetParameter = PS3TMAPI.ResetParameter.ResetEx; break;
                case ResetTarget.Soft: resetParameter = PS3TMAPI.ResetParameter.Soft; break;
            }
